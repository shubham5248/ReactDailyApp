...
export default class Post extends Component{
    ...
    onEditClickHandler=(id)=>{
        //here we get specific object by id from the list
        const editObject= this.state.posts.find((post)=>post.id===id);

        //here we set the object to state.postObject
    ...
    render(){
        return(
            ...
            {this.state.posts.map((posts, index)=>(
                ...
                <button onClick={()=>{this.onDeleteClickHandler(posts.id)}}>Delete</button> <span>   </span>
